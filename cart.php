...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Borrar Elemento" onclick="return confirm('¿Eliminar esto del carrito?');" class="delete-btn" name="delete">
   </form>
   <?php
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('¿Borrar todo del carrito?');">¿Eliminar todos los elementos?</a>
