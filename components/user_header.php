...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo"><div class="navbar-logo">
      <img src="./images/anticucheria_beny_logo.png"/></div>Anticucheria<span>Beny</span></a>
      ...
      <div class="profile">
         ...
         <div class="flex-btn">
            ...
            <a href="user_login.php" class="option-btn">Acceso</a>
         </div>
